...
\usepackage{setspace}
\usepackage{cite}
\usepackage{indentfirst} %primeiro parï¿½grafo
...
\usepackage{listings} %para formatar cï¿½digo-fonte
\lstset{numbers=left, numberstyle=\tiny, stepnumber=1, numbersep=5pt,basicstyle=\scriptsize,frame=single} %para cï¿½digos
...
%=============================================================================================%
\begin{document}
	\include{2ELE049.Capa}
	\include{2ELE049.Sumario}
	\include{2ELE049.Resumo}
	\include{2ELE049.Objetivos}
	\include{2ELE049.Revisao}
	\include{2ELE049.Metodologia}
	\include{2ELE049.Resultados}
	\include{2ELE049.Conc.ref}
	%\include{2ELE049.Anexos}
\end{document}
%=============================================================================================%
